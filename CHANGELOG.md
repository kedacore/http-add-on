...
- **Interceptor**: Extend `interceptor_request_duration_seconds` buckets up to `300s` (was `10s`) and add a `cold_start` label identifying requests that waited for a cold backend ([#1776](https://github.com/kedacore/http-add-on/issues/1776))
