...
func (lw *fakeDeploymentListerWatcher) events() []watch.Event {
	return lw.rec.Events()
}

func (lw *fakeDeploymentListerWatcher) stopWatcher() {
	lw.rffw.Stop()
}

func (lw *fakeDeploymentListerWatcher) isWatcherStopped() bool {
	return lw.rffw.IsStopped()
}
