...
var (
	...
	testIRNN                = types.NamespacedName{Namespace: testIRNamespace, Name: testIRName}
	testIRConcurrencyMetric = ConcurrencyMetricName(testIRNN)
	testIRRateMetric        = RateMetricName(testIRNN)
