...
const (
	...
	ErrorCreatingInterceptorIngress          HTTPScaledObjectConditionReason = "ErrorCreatingInterceptorIngress"
...
// HTTPScaledObjectCondition stores the current state of the resource
...
type HTTPScaledObjectSpec struct {
	...
	// (optional) The hostname that should be routed to this app by the ingress controller.
	// If not specified, a Service will be created for this app with type 'LoadBalancer'.
	// If you do specify it, an Ingress object will be created and you'll be expected to be
	// running a properly configured ingress controller
