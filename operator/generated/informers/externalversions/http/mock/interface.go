...
//
//	mockgen -copyright_file=hack/boilerplate.go.txt -destination=operator/generated/informers/externalversions/http/mock/interface.go -package=mock -source=operator/generated/informers/externalversions/http/interface.go
//
