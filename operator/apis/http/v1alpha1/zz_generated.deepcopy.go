...
func (in *ColdStartStreamingCallbackSpec) DeepCopyInto(out *ColdStartStreamingCallbackSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ColdStartStreamingCallbackSpec.
func (in *ColdStartStreamingCallbackSpec) DeepCopy() *ColdStartStreamingCallbackSpec {
	if in == nil {
		return nil
	}
	out := new(ColdStartStreamingCallbackSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HTTPScaledObjectSpec) DeepCopyInto(out *HTTPScaledObjectSpec) {
	*out = *in
	...
	if in.ColdStartStreamingCallback != nil {
		in, out := &in.ColdStartStreamingCallback, &out.ColdStartStreamingCallback
		*out = new(ColdStartStreamingCallbackSpec)
		**out = **in
	}
}
