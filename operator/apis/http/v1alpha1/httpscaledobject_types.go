...
type ColdStartTimeoutFailoverRef struct {
	...
	// The port to route to referenced by name
	PortName string `json:"portName,omitempty"`
	// The timeout in seconds to wait before routing to the failover service
	// +kubebuilder:default=30
	// +optional
	TimeoutSeconds int32 `json:"timeoutSeconds,omitempty" description:"The timeout in seconds to wait before routing to the failover service (Default 30)"`
}
